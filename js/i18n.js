...
(function () {
  ...
  var TRANSLATIONS = {
    ...
    es: {
      ...
      n_matches:             '{n} partidas',
      // settings modal
      settings:              'CONFIGURACIÓN',
      format:                'FORMATO',
      map_pool:              'MAPAS ACTIVOS',
