  ...
  const CHANGELOG = [
    {
      version: 'v1.02',
      changes: [
        'Soporte de 3 jugadores: cada uno elige su mapa y su campeón por mapa',
        'Formato king of the hill: J1 vs J2 → Perdedor vs J3 → Final',
        'Formulario de inicio: campo dinámico para agregar jugadores con botón +',
        'Ranking: trofeos 🏆 con colores por posición (naranja/dorado/plateado)',
        'Ranking: gráfico de torta con distribución de victorias',
      ],
    },
    {
      version: 'v1.1',
      changes: [
        'Ranking: gráfico de torta (donut) con victorias por jugador',
        'Ranking: trofeos 🏆 dorado, plateado y naranja para el top 3',
      ],
    },
    {
      version: 'v1.0',
